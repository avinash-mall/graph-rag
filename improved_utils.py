"""
Improved utilities for Graph RAG with efficient NLP preprocessing and better architecture.
This module replaces the heavy LLM-based NER with lightweight spaCy models and implements
...
logger = logging.getLogger("ImprovedUtils")
...
class EfficientNLPProcessor:
    ...
    def _simple_coref_resolution(self, text: str) -> str:
        ...
        if persons:
            ...
            # This is very basic - real coreference resolution is much more complex
...
class AsyncLLMClient:
    """
    Improved async LLM client with better error handling and retry logic
    """
